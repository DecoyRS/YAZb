...
class ZigWordScanner : DefaultWordsScanner(ZigLexerAdapter(), TokenSet.create(ZigTypes.IDENTIFIER), TokenSet.orSet(tokenSetOf(ZigTypes.DOC_COMMENT, ZigTypes.CONTAINER_DOC_COMMENT, ZigTypes.LINE_COMMENT)), TokenSet.orSet(
    tokenSetOf(ZigTypes.LINE_STRING, ZigTypes.STRING_LITERAL_SINGLE))) {
    init {
